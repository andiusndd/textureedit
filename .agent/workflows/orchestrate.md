...
4. **Current Plan State:** If `.agent/plans/` has a plan, include it
5. **Activated Skills:** List of skills activated from `.agent/skills/`
...
- Activated Skills: ui-ux-pro-max, clean-code, vue-expert
